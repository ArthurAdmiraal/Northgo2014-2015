...
///////////////////////////////////////////////////////////////////////////
// Omniturn.c                                                            //
// An example of the the use of the OmniWheelDriver library              //
...
task main()
{
	...
	while(true) {
		...
		// apply a dead zone to the joystick data
		...
		OWsetDriveVec(x1, y1);
		OWsetTurnTargetRelative(deadZonei(joystick.joy1_x2, LIMIT)*2/127);
